...
<div class="container">
    <div class="d-flex justify-content-center h-100">
        <div class="card">
            <h3 class="card-title mt-3 text-center" style="color: white">Doctors Registration</h3>
                     
        <div class="card-body">
        <form method="POST" action='/register/doctor' >
            @csrf
        ...
        <p class="text-center">Have an account? <a href="/login/doctor">Log In</a> </p>                                                                 
    </form>
        </div>
            </div>
        </div>
